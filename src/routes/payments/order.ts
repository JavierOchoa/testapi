...
orderRouter.post('/', async (req, res) => {
    ...
    try{
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `${process.env.API_URL}:${process.env.PORT}/order/success?session_id={CHECKOUT_SESSION_ID}`,
            cancel_url: `${process.env.API_URL}:${process.env.PORT}/order/failure?session_id={CHECKOUT_SESSION_ID}`,
            payment_intent_data: {
